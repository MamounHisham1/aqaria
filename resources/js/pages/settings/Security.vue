...
defineOptions({
    layout: {
        breadcrumbs: [
            {
                title: 'settings_security_breadcrumbs',
                href: edit(),
            },
        ],
    },
...
<template>
    <Head :title="t('settings_security_title')" />

    <h1 class="sr-only">{{ t('settings_security_title') }}</h1>

    <div class="space-y-6">
        <Heading
            variant="small"
            :title="t('update_password')"
            :description="t('update_password_desc')"
        />
