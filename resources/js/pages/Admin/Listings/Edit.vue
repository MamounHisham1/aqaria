...
const form = useForm({
    ...
    area_sqm: String(props.listing.area_sqm),
    bedrooms: String(props.listing.bedrooms),
    bathrooms: String(props.listing.bathrooms),
    property_type: props.listing.property_type,
    listing_type: props.listing.listing_type,
    city: props.listing.city,
    district: props.listing.district,
    address: props.listing.address,
    contact_phone: props.listing.contact_phone,
    contact_whatsapp: props.listing.contact_whatsapp || '',
    is_featured: props.listing.is_featured,
    is_active: props.listing.is_active,
    images: (props.listing.images || []) as (File | string)[],
...
function submit() {
    form.put(adminListings.update(props.listing.id).url, {
        forceFormData: true,
    });
}
</script>
...
<template>
    <Head :title="t('edit_listing')" />

    <div class="p-4 sm:p-6">
        <div class="mx-auto max-w-3xl">
            <h1 class="mb-4 text-xl font-bold text-[#1F1F1F] sm:mb-6 sm:text-2xl">{{ t('edit_listing') }}</h1>
            ...
            <form @submit.prevent="submit" class="space-y-4 sm:space-y-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-4 sm:p-6">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            ...
                            <input v-model="form.title" type="text" required class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                            <p v-if="form.errors.title" class="mt-1 text-sm text-red-500">{{ form.errors.title }}</p>
                        </div>
                        <div class="sm:col-span-2">
                            <label class="mb-1.5 block text-sm font-medium text-[#1F1F1F]">{{ t('description_label') }} *</label>
                            <textarea v-model="form.description" rows="4" required class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30"></textarea>
                            <p v-if="form.errors.description" class="mt-1 text-sm text-red-500">{{ form.errors.description }}</p>
                        </div>
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-[#1F1F1F]">{{ t('price_egp_label') }} *</label>
                            <input v-model="form.price" type="number" required class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                        ...
                        <div>
                            ...
                            <input v-model="form.area_sqm" type="number" required class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                        ...
                        <div>
                            ...
                            <input v-model="form.bedrooms" type="number" min="0" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                        </div>
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-[#1F1F1F]">{{ t('bathrooms_label') }}</label>
                            <input v-model="form.bathrooms" type="number" min="0" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                        </div>
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-[#1F1F1F]">{{ t('property_type_label') }} *</label>
                            <select v-model="form.property_type" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30">
                        ...
                        <div>
                            ...
                            <select v-model="form.listing_type" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-4 sm:p-6">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input v-model="form.city" type="text" required class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                        ...
                        <div>
                            ...
                            <input v-model="form.district" type="text" required class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input v-model="form.address" type="text" required class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-4 sm:p-6">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input v-model="form.contact_phone" type="text" required class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                        ...
                        <div>
                            ...
                            <input v-model="form.contact_whatsapp" type="text" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-base text-[#1F1F1F] focus:border-[#FFC107] focus:outline-none focus:ring-2 focus:ring-[#FFC107]/30" />
                        </div>
                    </div>
                </div>
                ...
                <!-- Actions -->
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                    <button type="submit" :disabled="form.processing" class="w-full rounded-xl bg-[#FFC107] px-6 py-3.5 text-base font-semibold text-[#1F1F1F] hover:bg-yellow-500 disabled:opacity-50 sm:w-auto">{{ t('update_listing_btn') }}</button>
                    <Link :href="adminListings.index().url" class="w-full rounded-xl border border-gray-200 px-6 py-3.5 text-center text-base font-medium text-[#1F1F1F] hover:bg-gray-50 sm:w-auto">{{ t('cancel') }}</Link>
                </div>
            </form>
        </div>
    </div>
